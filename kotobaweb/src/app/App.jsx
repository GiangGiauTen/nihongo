...
import FlashCardJoin from '../flashcard/join';
import FlashCardRoom from '../flashcard/game';
    ...
    <BrowserRouter>
      <div>
        ...
        <Switch>
          ...
          <Route
            exact
            path="/shiritori/create"
            component={ShiritoriGameCreate}
          />
          <Route exact path="/flashcard/create" component={FlashCardCreate} />
          <Route exact path="/flashcard/game" component={FlashCardRoom} />
          <Route exact path="/flashcarde/join" component={FlashCardJoin} />
          <Route
            exact
            path="/shiritori/create"
            component={ShiritoriGameCreate}
          ...
          <Route
            exact
            path="/"
            render={() => <Redirect to="/kanjigame/create" />}
          />
